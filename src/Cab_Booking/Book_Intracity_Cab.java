...
public class Book_Intracity_Cab extends JFrame implements ActionListener {
    ...
    Book_Intracity_Cab(){
        ...
        f1=new Font("Airal",Font.BOLD,25);
        f2=new Font("Airal",Font.BOLD,18);
        ...
        try{
            ...
            String q1="select DISTINCT source from intracity_driver";
        ...
        ch1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    String q4="select destination from intracity_driver where source='"+source+"'";
        ...
        ch2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try{
                    ...
                    String q5="select * from intracity_driver where source='"+source+"' and destination='"+dest+"'";
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==b1){
            ...
            try {
                ...
                String q6="insert into intracity_booked_details values('"+bid+"','"+cid+"','"+driver+"','"+car+"','"+from+"','"+to+"','"+price+"')";
